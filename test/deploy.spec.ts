...
import { convertGramToNum, convertNumToGram, createKycForDeploy } from '../src/utils/common'; // this is the interface class from tutorial 2
...
describe('Kyc deploy tests', () => {
    ...
    const initialAccounts: Dictionary<number, boolean> = Dictionary.empty(); // todo: fill dictionary
